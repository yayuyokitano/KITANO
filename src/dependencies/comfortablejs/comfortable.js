    ...
    (function (renderer) {
        renderer.createTextEditorSelectBox = function (editor) {
            ...
            var showOptions = function () {
                ...
                comfortable.util.set(options.$el, {
                    style: {
                        position: 'absolute',
                        left: off.left + 'px',
                    ...
                    on: {
                        mousedown: function (event) {
                            var mouseupHandler = function () {
                                comfortable.util.$(document).off('mouseup', mouseupHandler);
                                optionsMouseDown = false;
                            };
                            comfortable.util.$(document).on('mouseup', mouseupHandler);
    ...
    var TableImpl = (function (_super) {
        ...
        function TableImpl(model) {
            ...
            _this.document_keydownHandler = function (event) {
                if (!(event.keyCode == 18 || event.keyCode == 25) &&
                    event.altKey) {
