export function deckContent(deckName:string, numberRev:string, numberNew:string) {
  return `<a class="gotoDeck">
    ...
    <div class="deckBtnList">
      ...
      <button class="deckDelete deckBtn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="18px" height="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6 21h12V7H6v14zM8 9h8v10H8V9zm7.5-5l-1-1h-5l-1 1H5v2h14V4h-3.5z"/></svg></button>
    </div>
