export function deckContent(deckName:string, deckFile:string, deckID:string, numberRev:string, numberNew:string) {
  return `<a class="gotoDeck" deckfile="${deckFile}">
    ...
    <div class="deckBtnList">
      ...
      <button class="deckDelete deckBtn" onclick="deleteDeck(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="18px" height="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6 21h12V7H6v14zM8 9h8v10H8V9zm7.5-5l-1-1h-5l-1 1H5v2h14V4h-3.5z"/></svg></button>
    </div>
...
export const settingMap = {
  Appearance: `<h2>Appearance</h2><span>Theme: </span><select class="themeSelect" onchange="listeners.changeTheme(this.value); this.blur()"><option value="light">Light</option><option value="dark">Dark</option></select>`
}

export const newDeck = {
  "New Deck": "<h1>yeet</h1>",
  "Import Deck": "<h1>yeeet</h1>",
  "New Folder": "<h1>yeeeet</h1>"
}