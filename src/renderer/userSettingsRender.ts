export function setSettingsPopup(settings:any) {
    const appearance = `<h2>Appearance</h2><span>Theme: </span><select class="themeSelect" onchange="listeners.changeTheme(this.value); this.blur()"><option value="light">Light</option><option value="dark">Dark</option></select>`;
